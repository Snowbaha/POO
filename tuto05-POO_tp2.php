...
require 'tuto05-POO_tp2_personnage.php';
require 'tuto05-POO_tp2_manager.php';
...
{
  session_destroy();
  header('Location: tuto05-POO_tp2.php');
  exit();
}
...
{
?>
    <p><a href="tuto05-POO_tp2.php?deconnexion=1">Déconnexion</a></p>
